...
int e25519_sign(
	...
	return c25519::ss::vanilla::sign(pbuffer, plen, sbuffer, slen, mbuffer, mlen, obuffer, olen);
}
...
int e25519_verify(
	...
	return c25519::ss::vanilla::verify(pbuffer, plen, mbuffer, mlen, obuffer, olen);
}
...
int i25519_extract(
	...
	return c25519::ibi::extract(pbuffer, plen, sbuffer, slen, mbuffer, mlen, obuffer, olen);
}
...
int i25519_verify(
	...
	return c25519::ibi::verify(pbuffer, plen, port, timeout);
}
